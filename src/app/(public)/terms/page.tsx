    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-6 text-text-muted leading-relaxed">
          <section>
            <h2 className="text-lg font-semibold text-text-primary mb-2">1. Use of Service</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-text-primary mb-2">2. Affiliate Disclosure</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-text-primary mb-2">3. Intellectual Property</h2>
            <p>
