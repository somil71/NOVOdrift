    ...
    <>
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-6 text-on-surface-variant leading-relaxed">
          <section>
            <h2 className="text-lg font-semibold text-on-surface mb-2">Data We Collect</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-on-surface mb-2">Cookies</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-on-surface mb-2">Third-Party Links</h2>
            <p>
